...
import { assertUserCanAccessAppById, assertUserCanSendMessagesById } from "../../lib/user-access.js";
import { buildUserPresencePayload, emitChatMessage, emitPresenceUpdate, emitChatStatus, emitInboxUpdate, getSocketsInUserRoom, registerUserSocket, sessionRoom, unregisterUserSocket, userRoom } from "./chat.realtime.js";
...
async function notifyPresenceAudience(userId) {
...
async function sendDirectPeerPresenceSnapshot(socket, chatId, userId) {
