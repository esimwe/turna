...
const resolvedEnv = {
  ...
  COMMUNITY_R2_ACCOUNT_ID: process.env.COMMUNITY_R2_ACCOUNT_ID,
  COMMUNITY_R2_BUCKET: process.env.COMMUNITY_R2_BUCKET,
  COMMUNITY_R2_ENDPOINT: process.env.COMMUNITY_R2_ENDPOINT,
  COMMUNITY_R2_ACCESS_KEY_ID: process.env.COMMUNITY_R2_ACCESS_KEY_ID,
  COMMUNITY_R2_SECRET_ACCESS_KEY: process.env.COMMUNITY_R2_SECRET_ACCESS_KEY,
...
const envSchema = z.object({
  ...
  COMMUNITY_R2_ACCOUNT_ID: z.string().min(1).optional(),
  COMMUNITY_R2_BUCKET: z.string().min(1).optional(),
  COMMUNITY_R2_ENDPOINT: z.string().url().optional(),
  COMMUNITY_R2_ACCESS_KEY_ID: z.string().min(1).optional(),
  COMMUNITY_R2_SECRET_ACCESS_KEY: z.string().min(1).optional(),
