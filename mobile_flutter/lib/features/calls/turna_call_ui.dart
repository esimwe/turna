...
class _GroupCallPageState extends State<GroupCallPage> {
  ...
  TurnaGroupCallState? get _groupCallState => _hasSyncedCallState
  ...
  void _handleGroupCallStateChanged() {
    ...
    if (widget.chatClient.activeGroupCallState == null &&
        mounted &&
        !_leaving) {
  ...
  Widget _buildParticipantTile(
    ...
    final hasVideo =
        item.videoTrack != null && widget.connect.type == TurnaCallType.video;
    ...
    if (!useSpotlight) {
      return GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          mainAxisSpacing: 12,
          crossAxisSpacing: 12,
          childAspectRatio: widget.connect.type == TurnaCallType.video
              ? 0.78
              : 1.05,
        ),
